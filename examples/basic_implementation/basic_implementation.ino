...
<body>
  ...
  String handleIncrement(const String& requestBody, const std::map<String, String>& params) {
    counter++;
    return "{\"success\":true,\"counter\":" + String(counter) + "}";
  }
  
  String handleReset(const String& requestBody, const std::map<String, String>& params) {
    counter = 0;
    return "{\"success\":true,\"counter\":" + String(counter) + "}";
  }
